...
// ExecLocal_Start action
func (l *Powerball) ExecLocal_Start(payload *pty.PowerballStart, tx *types.Transaction, receiptData *types.ReceiptData, index int) (*types.LocalDBSet, error) {
	return l.execLocal(tx, receiptData)
}
