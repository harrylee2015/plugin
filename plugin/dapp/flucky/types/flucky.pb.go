...
func (m *Config) GetPlatformAddr() string {
	if m != nil {
...
func (m *Config) GetMaxBonus() float32 {
	if m != nil {
		return m.MaxBonus
	}
	return 0
...
func (m *Config) GetMinBonus() float32 {
	if m != nil {
		return m.MinBonus
	}
	return 0
...
func (m *Config) GetPlatformToBonus() float32 {
	if m != nil {
...
func (m *Config) GetBonusToPlatform() float32 {
	if m != nil {
...
func (m *Config) GetRewardRule() []*Rule {
	if m != nil {
		return m.RewardRule
	}
	return nil
...
func (m *Config) GetBetTimeRule() []*BetTime {
	if m != nil {
...
var fileDescriptor0 = []byte{
	...
	,
}
